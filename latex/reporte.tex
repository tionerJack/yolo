...
\begin{titlepage}
  ...
  {\fontsize{14}{18}\selectfont\color{tenam-light} Sistema Web de Detección con ESP32-CAM y YOLO}\\[0.5cm]
  {\fontsize{12}{14}\selectfont\color{white} Por: \textbf{Ismael Rufino Grajeda Marin}}
  ...
  \vfill
  \begin{tabular}{ll}
    \textbf{Nombre:} & Ismael Rufino Grajeda Marin \\[4pt]
    \textbf{Fecha:} & \today \\[4pt]
    \textbf{GitHub:} & \href{https://github.com/tionerJack/yolo?tab=readme-ov-file}{\texttt{github.com/tionerJack/yolo}} \\[4pt]
    \textbf{Demo:} & \href{https://tenam-vision-yolo-1773976989.web.app/}{\texttt{tenam-vision-yolo.web.app}} \\[4pt]
